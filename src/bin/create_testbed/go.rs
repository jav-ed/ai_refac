...
pub fn generate(root: &Path) -> std::io::Result<()> {
    ...
    create_file(&base, "go.mod", r#"module example.com/bank

go 1.21
"#)?;

    // 1. Core Model (File 1)
    create_file(&base, "pkg/model/account.go", r#"package model
...
"#)?;
    ...
    // 2. Utils (File 2)
    create_file(&base, "pkg/utils/currency.go", r#"package utils
...
"#)?;
    ...
    create_file(&base, "pkg/service/ledger.go", r#"package service
...
"#)?;
    ...
    create_file(&base, "pkg/audit/logger.go", r#"package audit
...
"#)?;
    ...
    create_file(&base, "pkg/config/settings.go", r#"package config
...
"#)?;
    ...
    create_file(&base, "cmd/server/main.go", r#"package main
